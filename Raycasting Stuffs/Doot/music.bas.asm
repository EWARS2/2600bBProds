...
.L02 ;  rem  *  Music Starter using sdata

.L03 ;  rem  *

.L04 ;  rem  *  Based on code posted in the Ballblazer thread at AtariAge:

.L05 ;  rem  *  http://www.atariage.com/forums/index.php?s=&showtopic=130990&view=findpost&p=1615280

.L06 ;  rem  *

.L07 ;  rem  *  Code adapted by Duane Alan Hahn (Random Terrain)

.L08 ;  rem  *

.L09 ;  rem  *  Explanation:

.L010 ;  rem  *  The 256-byte limitation is removed when using sdata.

.L011 ;  rem  *  You can fill a whole 4k bank with music if you want.
...
.L016 ;  rem  *  Create aliases for variables
...
.L021 ;  rem  *  Variable descriptions

.L022 ;  rem  *****************************************************

.L023 ;  rem  *  duration - how long each note plays

.L024 ;  rem  *  x - used for sdata

.L025 ;  rem  *  y - used for sdata

.L026 ;  rem  *  rand16 - makes better random numbers
...
.L030 ;  rem  *  Initialize duration and set up music

.L031 ;  duration  =  1

	LDA #1
	STA duration
.L032 ;  goto MusicSetup
...
.L035 ;  rem  *  Main game loop starts here.
...
.L044 ;  rem  *  Check for end of current note

.L045 ;  duration  =  duration  -  1

	DEC duration
.L046 ;  if duration > 0 then GotMusic

	LDA #0
	CMP duration
 if ((* - .GotMusic) < 127) && ((* - .GotMusic) > -128)
	bcc .GotMusic
 else
	bcs .0skipGotMusic
	jmp .GotMusic
...
.L047 ;  rem  *  Retrieve channel 0 data

.L048 ;  temp4  =  sread ( musicData ) 
...
.L051 ;  rem  *  Check for end of data

.L052 ;  if temp4 = 255 then duration  =  1  :  goto MusicSetup
...
.L057 ;  rem  *  Retrieve channel 1 data

.L058 ;  temp4  =  sread ( musicData ) 
...
.L065 ;  rem  *  Set duration

.L066 ;  duration  =  sread ( musicData ) 
...
.L069 ;  rem  *  Music Data Block

.L070 ;  rem  *****************************************************

.L071 ;  rem  *  Format:

.L072 ;  rem  *  v,c,f (channel 0)

.L073 ;  rem  *  v,c,f (channel 1) 

.L074 ;  rem  *  d

.L075 ;  rem  *

.L076 ;  rem  *  Explanation:

.L077 ;  rem  *  v - volume (0 to 15)

.L078 ;  rem  *  c - control [a.k.a. tone, voice, and distortion] (0 to 15)

.L079 ;  rem  *  f - frequency (0 to 31)
